...
const getData = async (setUserData, setError, setRoleData,setLoading) => {
...
const Page = () => {
  ...
  useEffect(() => {
    getData(setUserData, setError, setRoleData ,setLoading)
  }, [])
  ...
  return <Adminroles userData={userData} roleData={roleData} />
}
