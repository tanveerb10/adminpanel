...
//         header: 'User',
//         cell: ({ row }) => (
//           <div className='flex items-center gap-4' onClick={() => handleRowClick(row.original.id)}>
...
//             </IconButton>
//             <IconButton>
//               <Link href={getLocalizedUrl(`admin/adminusers/${row._id}`, locale)} className='flex'>
...
//               variant='contained'
//               startIcon={<i className='tabler-plus' />}
//               onClick={() => router.push(`/admin/adminusers/${id}`)}
//               className='is-full sm:is-auto'
//             >
//               Add New User
//             </Button>
