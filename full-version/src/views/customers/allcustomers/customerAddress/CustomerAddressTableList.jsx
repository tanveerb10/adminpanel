...
const CustomerAddressTableList = ({
  tableData,
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <IconButton>
            <Link href={getLocalizedUrl(`/customers/customeraddress/${row.original.id}`, locale)} className='flex'>
    ...
    <>
      <Card>
        ...
        <div className='flex justify-between flex-col items-start md:flex-row md:items-center p-6 border-bs gap-4'>
          ...
          <div>
            Total Customer:
            <Chip variant='outlined' label={totalCustomerAddress} color='warning' size='small' className='ml-2' />
          </div>
...
export default CustomerAddressTableList
