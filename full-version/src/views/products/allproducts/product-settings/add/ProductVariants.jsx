...
//     // @ts-ignore
//     e.target.closest('.variant-input').remove()
//   }
//   const deleteForm = e => {
//     e.preventDefault()
...
//   const variantInput = e => {
//     e.preventDefault()
//     if (e.target.value.length == 1) {
//       setValueCount(valueCount + 1)
//     }
//     // e.addEventListener("onClick",setValueCount(valueCount + 1 ))
//   }
...
//                           onChange={variantInput}
//                           onKeyDown={e => {
//                             console.log(e.key)
//                             if ((e.key === 'Backspace') === 0) {
//                               deleteInput()
//                             }
//                           }}
//                           InputProps={{
...
//                                 <IconButton onClick={deleteInput} className='min-is-fit'>
...
//                         {/* <IconButton onClick={deleteForm} className='min-is-fit'>
//                           <i className='tabler-x' />
//                         </IconButton> */}
//                       </>
//                     ))}
//                     <IconButton onClick={() => setValueCount(valueCount + 1)} className='min-is-fit'>
//                       <i className='tabler-plus' />
//                     </IconButton>
//                     {/* <IconButton onClick={deleteForm} className='min-is-fit'>
//                       <i className='tabler-x' />P
//                     </IconButton> */}
//                     <Button
//                       variant='outlined'
//                       color='error'
...
//               Add Another Option
//             </Button>
//             {/* <Button variant='contained' onClick={deleteForm} endIcon={<i className='tabler-trash' />}>
//               delete
//             </Button> */}
//           </Grid>
//           <Grid item xs={12} className='flex flex-col items-start gap-1'>
